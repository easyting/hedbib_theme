...
To use these stylesheets, rename the files and hedbib_theme with the name of your theme.
...
hedbib_theme-alpha-default.css
...
hedbib_theme-alpha-default-narrow.css  
...
hedbib_theme-alpha-default-normal.css
...
hedbib_theme-alpha-default-wide.css
